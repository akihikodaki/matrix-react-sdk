...
class CategoryRoomList extends React.PureComponent {
    static propTypes = {
...
class FeaturedRoom extends React.PureComponent {
    static propTypes = {
...
class RoleUserList extends React.PureComponent {
    static propTypes = {
...
class FeaturedUser extends React.PureComponent {
    static propTypes = {
