...
module.exports = withMatrixClient(class MemberInfo extends React.PureComponent {
    static propTypes = {
    ...
    _updateStateForNewMember = (member) => {
    ...
    _calculateOpsPermissions = (member) => {
        const defaultPerms = {
            can: {},
            muted: false,
        };
